...
?>
<section id="jumbotron" class="jumbotron text-center mt-5 pb-5 px-0">
<div class="container" >
...
<div class="row">
	<div class="col-md-1 fixed-top" id="acessibilidade1" style="margin-top: 300px;">
		...
		<button type="button" id="botao-cor" class="btn btn-dark" onclick="trocar();">Alterar cor</button>
			  ...
			  <div class="row justify-content-md-center">	
				...
				<h3>Vamos estudar?</h3>
					...
					<p>
						...
						<br>
						Efetuando a divisão de 1 por 2, obtemos o quociente 0,5.
					</p>
...
"20/20"];
					...
					$b = str_ireplace("/","",substr($array[$x],2,3));
					...
					?>
					  <center><h1><?=$a;?> &divide; <?=$b;?> = ?</h1></center>
			  ...
			  <div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
				  <div class="modal-header">
					<h4 class="modal-title" id="exampleModalCenterTitle">Resposta Errada &nbsp; <img src="img/delete.png" width="7%"></h4>
					
				  </div>
				  <div class="modal-body">
					<h4>A resposta correta é: </h4>
					<h4><?=$a;?> &divide; <?=$b;?> = <?=$a/$b;?></h4>
				  </div>
				  <div class="modal-footer">
					<button type="button" onClick="gototab();" class="btn btn-danger">Praticar novamente</button>
				  </div>
				</div>
			  </div>
			</div>
			...
			<div class="modal fade" id="modalRespostaCerta" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			  <div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
				  <div class="modal-header">
					<h4 class="modal-title" id="exampleModalCenterTitle">Resposta Correta &nbsp; <img src="img/correct-symbol.png" width="8%"></h4>
					<!--<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					  <span aria-hidden="true">&times;</span>
					</button> -->
				  </div>
				  <div class="modal-body">
					<h2><?=$a;?> &divide; <?=$b;?> = <?=$a/$b;?></h2>
				  </div>
				  <div class="modal-footer">
	...
	<div class="col-md-2">
		...
		<a id="link-audio" class="link-card" href="#" style="text-decoration:none;">
		...
		<!-- Modal -->
			<div class="modal fade" id="modalVideo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
				<div class="modal-content">
				  <div class="modal-header">
					<h5 class="modal-title" id="exampleModalCenterTitle">Vídeo - Fração</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					  <span aria-hidden="true">&times;</span>
					</button>
				  </div>
				  <div class="modal-body text-center">
					<video  width="650"  controls>
					  <source src="video/fracao.mp4" type="video/mp4">
